...
export function CitizenDashboardFilters({
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="absolute left-1/2 top-[calc(100%+8px)] z-50 w-[min(240px,calc(100vw-2rem))] -translate-x-1/2 rounded-xl border border-gray-100 bg-white p-2 text-left shadow-[0_18px_44px_rgba(15,23,42,0.16)] md:bottom-[calc(100%+10px)] md:left-0 md:top-auto md:translate-x-0">

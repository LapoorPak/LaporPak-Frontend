...
export const CITIZEN_REPORT_STATUS_MAP: Record<string, ReportStatusMeta> = {
  ...
  clarification_requested: { label: "Butuh Klarifikasi", color: "bg-violet-50 text-violet-700 border-violet-200" },
...
export const AGENCY_REPORT_STATUS_MAP: Record<string, ReportStatusMeta> = {
  ...
  clarification_requested: { label: "Butuh Klarifikasi", color: "bg-violet-100 text-violet-700 border-violet-200" },

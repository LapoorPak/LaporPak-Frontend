...
export default function HelpCenter() {
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-[#C01D33]/20 selection:text-[#C01D33]">
      ...
      <main className="max-w-7xl mx-auto px-6 pt-20 pb-32 relative overflow-hidden">
        ...
        <section className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 lg:gap-24 mb-24">
           {/* Left: Illustration */}
           ...
           {/* Right: Hubungi Kami Text */}
           <div className="flex-1 text-center md:text-left">
              <h1 className="text-4xl md:text-5xl font-extrabold text-[#C01D33] mb-6 tracking-tight">Hubungi Kami</h1>
        ...
        {/* Bottom Section: Form & Layanan Pelanggan */}
        <section className="flex flex-col lg:flex-row gap-12 items-start">
           ...
           {/* Right: Layanan Pelanggan Sidebar */}
